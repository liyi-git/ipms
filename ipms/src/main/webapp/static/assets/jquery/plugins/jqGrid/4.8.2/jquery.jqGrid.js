...
$.jgrid.regional["cn"] = {
    ...
    search : {
        ...
        Find: "鏌ユ壘",
        Reset: "閲嶇疆",
        odata: [{ oper:'eq', text:'绛変簬\u3000\u3000'},{ oper:'ne', text:'涓嶇瓑\u3000\u3000'},{ oper:'lt', text:'灏忎簬\u3000\u3000'},{ oper:'le', text:'灏忎簬绛変簬'},{ oper:'gt', text:'澶т簬\u3000\u3000'},{ oper:'ge', text:'澶т簬绛変簬'},{ oper:'bw', text:'寮�濮嬩簬'},{ oper:'bn', text:'涓嶅紑濮嬩簬'},{ oper:'in', text:'灞炰簬\u3000\u3000'},{ oper:'ni', text:'涓嶅睘浜�'},{ oper:'ew', text:'缁撴潫浜�'},{ oper:'en', text:'涓嶇粨鏉熶簬'},{ oper:'cn', text:'鍖呭惈\u3000\u3000'},{ oper:'nc', text:'涓嶅寘鍚�'},{ oper:'nu', text:'涓嶅瓨鍦�'},{ oper:'nn', text:'瀛樺湪'}],
        groupOps: [ { op: "AND", text: "鎵�鏈�" },    { op: "OR",  text: "浠讳竴" } ],
    ...
    edit : {
        ...
        msg: {
            required:"姝ゅ瓧娈靛繀闇�",
            number:"璇疯緭鍏ユ湁鏁堟暟瀛�",
            minValue:"杈撳�煎繀椤诲ぇ浜庣瓑浜� ",
            maxValue:"杈撳�煎繀椤诲皬浜庣瓑浜� ",
            email: "杩欎笉鏄湁鏁堢殑e-mail鍦板潃",
            integer: "璇疯緭鍏ユ湁鏁堟暣鏁�",
            date: "璇疯緭鍏ユ湁鏁堟椂闂�",
            url: "鏃犳晥缃戝潃銆傚墠缂�蹇呴』涓� ('http://' 鎴� 'https://')",
            nodefined : " 鏈畾涔夛紒",
            novalue : " 闇�瑕佽繑鍥炲�硷紒",
            customarray : "鑷畾涔夊嚱鏁伴渶瑕佽繑鍥炴暟缁勶紒",
            customfcheck : "蹇呴』鏈夎嚜瀹氫箟鍑芥暟!"
        }
    },
    view : {
        caption: "鏌ョ湅璁板綍",
    ...
    errors : {
        ...
        model : "colNames 鍜� colModel 闀垮害涓嶇瓑锛�"
    },
    formatter : {
