...
<div class="aui-panel aui-nomargin" id="pool-view-tab" val="tab-overview">
	<ul class="aui-tab-panel fn-hide">
		<li val="tab-overview" target="panel-overview" url="<c:url value="/pool/C_${CITY_ID}/summary"/>">地址池概况</li>
		<li val="tab-stat" target="panel-stat" url="<c:url value="/pool/C_${CITY_ID}/statistic"/>">地址池统计</li>
	</ul>
