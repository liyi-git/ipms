...
require([ 'jquery','underscore','module/main','enums','echart-chart/pie','table'], function($,_,main,enums,echart) {
	$(document).ready(function(){
		loadChart(_g_const.ctx+'/pool/statistic/statPlanStatus',{},$("#statchart-plan"),function(data){
			return convertData(data,enums.planStatus);
		});
		loadChart(_g_const.ctx+'/pool/statistic/statUseStatus',{},$("#statchart-use"),function(data){
