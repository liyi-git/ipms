...
public class WebVisitEventPublish implements ApplicationEventPublisherAware {
  ...
  public void operateEvent(OperateTypeEnum operateCodeEnum, String operateObj,
      OperateObjTypeEnum ObjType, String poolId, String cityId) {
    this.operateEvent(operateCodeEnum, operateObj, ObjType, poolId, cityId, null,
        OperateWayEnum.INNER_INVOKE);
  }

  public void operateEvent(OperateTypeEnum operateCodeEnum, String operateObj,
      OperateObjTypeEnum ObjType, String poolId, String cityId, String operateCont) {
    this.operateEvent(operateCodeEnum, operateObj, ObjType, poolId, cityId, operateCont,
        OperateWayEnum.INNER_INVOKE);
  }

  public void operateEvent(OperateTypeEnum operateCode, String operateObj,
      OperateObjTypeEnum ObjType, String poolId, String cityId, String operateCont,
      OperateWayEnum operateWay) {
    ...
    operateLogEntity.setCityId(cityId);
    operateLogEntity.setOperateSource(operateWay.getCode());
    OperateEvent event;
    if (operateWay.getCode().equals(OperateWayEnum.INNER_INVOKE.getCode())) {
      event = new OperateEvent(this, operateLogEntity);
    } else {
      event = new InterfaceOperateEvent(this, operateLogEntity);
    }
