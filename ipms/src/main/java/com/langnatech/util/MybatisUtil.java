...
import com.langnatech.core.extend.dialect.impl.DB2Dialect;
import com.langnatech.core.extend.dialect.impl.MySQLDialect;
import com.langnatech.core.extend.dialect.impl.OracleDialect;
    ...
    public static String getSql(SqlSessionFactory sessionFactory, String mapperId,
        ...
        if (rowBounds != null && dialect.supportsLimit()) {
            if (rowBounds instanceof PageQuery) {
                ...
                _sql = dialect.getSortString(_sql, pageQuery.getSortRuleList());
            }
