...
public class JsonConvertUtil {
    ...
    public JsonConvertUtil(Include include) {
     ...
     */
    public static JsonConvertUtil nonEmptyMapper() {
        return new JsonConvertUtil(Include.NON_EMPTY);
    }

    /**
     * 创建只输出初始值被改变的属性到Json字符串的Mapper, 最节约的存储方式，建议在内部接口中使用。
     */
    public static JsonConvertUtil nonDefaultMapper() {
        return new JsonConvertUtil(Include.NON_DEFAULT);
    }
    ...
    public static String toJSON(Object obj){
        return JsonConvertUtil.nonDefaultMapper().toJson(obj);
    }
}