...
public class Reflections {
     ...
     * @return map对象
     */
    public static Map<Object,Object> convertBeanToMap(Object object){
    	...
    	try {
			...
			logger.error("Reflections class(convertBeanToMap method)javabean转换Map时发生异常："+e);
			throw new RuntimeException("Reflections class(convertBeanToMap method)javabean转换Map时发生异常：", e);
