...
public class FilesUtil {
	...
	public static boolean createFile(String path) {
		...
		try {
			...
			isok = false;
			LoggerUtil.error(logger, "创建文件出错！"+e.getMessage());
		}
		return isok;
	}
	...
	public static boolean deleteFolder(String path) {
		...
		try {
			...
			isok = false;
			LoggerUtil.error(logger, "删除文件夹操作有误！"+e.getMessage());
		}
		return isok;
	}
	...
	public static boolean copyFile(String srcPath, String destPath) {
		...
		try {
			...
			isok = false;
			LoggerUtil.error(logger, "源文件不存在！"+e.getMessage());
		}
		return isok;
	}
	...
	public static boolean copyAllFolder(String srcPath, String destPath) {
		...
		try {
			...
			isok = false;
			LoggerUtil.error(logger, "文件夹复制出现问题！[{}]", e.getMessage());
		}
		return isok;
	}
