package com.langnatech.util.helper;
...
public class ObjectListHelper {
    ...
    public static <T> Map<String, ArrayList> sortObjectByProperty(Iterator<T> it, String propertyName) {
